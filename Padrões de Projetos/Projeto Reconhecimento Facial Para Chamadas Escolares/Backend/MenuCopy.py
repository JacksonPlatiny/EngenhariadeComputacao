...
class Menu:
    ...
    def cadastro_cadeira(self,matricula,codigo,nome, semestre):
        id_professor = matricula
        self.controle.criar_cadeira(codigo, id_professor, nome, semestre)
            
    def cadastro_aluno(self,id_cadeira,matricula_aluno,nome_aluno, foto):
        # professor = self.controle.encontrar_cadeira_do_professor(matricula)
        self.controle.criar_aluno(nome_aluno, matricula_aluno, id_cadeira,foto)
