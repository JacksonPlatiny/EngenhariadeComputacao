...
"background-color: rgb(51, 51, 51);")
        ...
        self.lineEdit_matricula = QtWidgets.QLineEdit(self.login)
        self.lineEdit_matricula.setGeometry(QtCore.QRect(510, 240, 320, 45))
        font = QtGui.QFont()
...
"    border: 2px solid rgb(45,12,45,45)\n"
"    border-radius: 5px;\n"
"    padding: 15px;\n"
...
"")
        ...
        self.pushButton_criar_conta = QtWidgets.QPushButton(self.login)
        self.pushButton_criar_conta.setGeometry(QtCore.QRect(510, 370, 320, 45))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButton_criar_conta.setFont(font)
        self.pushButton_criar_conta.setStyleSheet("QPushButton {\n"
"    \n"
"    background-color: rgb(51, 51, 51);\n"
...
"")
        ...
        self.label.setGeometry(QtCore.QRect(620, 100, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        ...
        self.label_2.setGeometry(QtCore.QRect(630, 140, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.lineEdit_nome = QtWidgets.QLineEdit(self.login)
        self.lineEdit_nome.setGeometry(QtCore.QRect(510, 190, 320, 45))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
        font.setBold(True)
...
"")
    ...
    def retranslateUi(self, Login):
        ...
        self.lineEdit_matricula.setPlaceholderText(_translate("Login", "Matrícula"))
        self.lineEdit_senha.setPlaceholderText(_translate("Login", "Senha"))
        self.pushButton_criar_conta.setText(_translate("Login", "Criar Conta"))
        self.label.setText(_translate("Login", "Cadastro"))
        self.label_2.setText(_translate("Login", "Crie sua conta"))
        self.lineEdit_nome.setPlaceholderText(_translate("Login", "Nome"))
import file_rc_rc
